...
const DEFAULT_TEXT_NUMBER = <NormalText text={'05'} isBold fontSize={30} textColor={'rgba(255, 255, 255, 0.5)'} isAnimated />;
...
class DownScreen extends React.Component {
    ...
    handleMouseMove = event => {
        ...
        this.setState({
            mouseXPosition: mouseX - (window.innerWidth * 0.40),
    ...
    renderTextNumber = activeListItemIndex => {
        return <NormalText text={`0${activeListItemIndex + 1}`} isBold fontSize={30} key={activeListItemIndex} isAnimated />
    }
